public class MagnetItemShopView : ItemShopView
{
    ...
    {
        if (ContainerSaveerPlayerPrefs.Instance.SaveerData.IsPurchasedMagnet == 1)
    ...
    {
        ContainerSaveerPlayerPrefs.Instance.SaveerData.IsPurchasedMagnet = 1;
        SetActiveButtons(false, true);
    }
